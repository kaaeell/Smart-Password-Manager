...
class PasswordManager:
    ...
    def _setup_master_password(self):
        ...
        while True:
            password = getpass("Create master password (min 4 characters): ")
    ...
    def add_entry(self):
        ...
        password = ""
        if choice == "1":
            length_input = input("Password length (default 14, min 6): ").strip()
    ...
    def delete_entry(self):
        ...
        try:
            ...
            entry = self.data[choice - 1]
            confirm = input(f"⚠️  Delete '{entry['site']}'? Type 'yes' to confirm: ")
    ...
    def show_statistics(self):
        ...
        print(f"   ⚠️  Medium: {medium} ({medium*100//len(self.data)}%)")
        print(f"   ❌ Weak: {weak} ({weak*100//len(self.data)}%)")
    ...
    def change_master_password(self):
        ...
        print("\n⚠️  WARNING: Changing master password will keep your data encrypted")
        print("   with the new password. You must remember this new password!\n")
        
        while True:
            new_password = getpass("New master password (min 4 chars): ")
